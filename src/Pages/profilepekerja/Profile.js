      ...
      <div className={style.main}>
         <div className={style.container+" d-flex flex-column align-items-center"}>
            ...
            <div className={style.profile}>
               ...
               <p className='h6'>{data.employee[0].jobs && data.employee[0].jobs }</p>
               <p className='h6'><img src={location} alt='location'/><span className='text-muted ml-3'>{data.employee[0].address && data.employee[0].address}</span> </p>
               <p className='text-muted my-3'>Freelancer</p>
               <p className='text-muted w-50'>{data.employee[0].description && data.employee[0].description}</p>
               <button className={style.button}>Hire</button>
            </div>
            <h3>Skill</h3>
            <div className={style.skills+' w-25'} >
               {
                  data.employee[0].skill ? data.employee[0].skill.map(data => <div className={style.skill}>{data}</div>) : "Not Skill Found"
               }
            </div>
            <div className={style.account+' w-25 mt-4'}>
               ...
               <div  className='mb-2'><img src={instagram} alt="" /><span className='text-muted ml-3'>{data.employee[0].instagram && data.employee[0].instagram}</span></div>
               <div  className='mb-2'><img src={github} alt=""/><span className='text-muted ml-3'>{data.employee[0].github && data.employee[0].github}</span></div>
            </div>
