    ...
    <Fragment>
        ...
        <div className={RegisterCSS.Cover}>
            <div className={RegisterCSS.wrapperPwImg}>
                ...
                <div className={RegisterCSS.wrapperCompanyName}>
                  <p>Perusahaan</p>
                  <input type="text" className={RegisterCSS.inpEmail} placeholder='Masukan nama perusahaan' />
                </div>
                <div className={RegisterCSS.wrapperPosisi}>
                  <p>Jabatan</p>
                  <input type="text" className={RegisterCSS.inpEmail} placeholder='Posisi di perusahaan anda' />
                </div>
              ...
              <p className={RegisterCSS.forgot}>Lupa kata sandi?</p>
